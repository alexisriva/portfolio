  ...
  <main className="space-y-12 text-center sm:text-left">
    <header className="space-y-8">
      ...
      <p className="text-xl sm:text-2xl text-neutral-400 font-light max-w-3xl leading-relaxed mx-auto sm:mx-0">
        Building the intersection of AI and modern development. With <span className="text-white font-medium">8 years</span> of full-stack experience, I craft scalable, intelligent systems that solve real-world problems.
      </p>
    </header>
    ...
    <nav className="flex flex-col sm:flex-row gap-6 pt-8">
      ...
      >
        ...
        <span className="text-sm font-medium tracking-wide uppercase">GitHub</span>
      </a>
    </nav>
  </main>
);
