...
const Projects = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const response = await fetch('https://api.github.com/users/alexisriva/repos?sort=updated&direction=desc&per_page=6')
  ...
  return (
    <section className="space-y-12">
      <h2 className="text-3xl font-bold tracking-tight text-neutral-200">Projects</h2>
